...
//		PointD latLonProjected = plotProj.rotateLatLon(lon, lat);
	...
	private static DateTime MYRORSS_OP_START = new DateTime(1998, 4, 22, 12, 0, 0, DateTimeZone.UTC);
	private static DateTime MYRORSS_OP_END = new DateTime(2012, 1, 1, 12, 0, 1, DateTimeZone.UTC);
