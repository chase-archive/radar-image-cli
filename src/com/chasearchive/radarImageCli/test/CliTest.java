...
//		String[] args1 = {"-dt", "20240430_2353", "-lat", "34.86", "-lon", "-98.96", "-a", "4:3", "-s", "0.5", "-c", "NEXRAD", "-debug", "SILENT", "-o", "radargen-case-rooseveltOk-newProj-zoomedIn.png"};
//		String[] args1 = {"-dt", "20240811_1100", "-lat", "35.18", "-lon", "-97.44", "-a", "4:3", "-s", "2.0", "-debug", "VERBOSE", "-o", "radargen-case-flood-zoomOut.png"};
//		String[] args1 = {"-dt", "20240503_0015", "-lat", "32.606786", "-lon", "-99.855", "-a", "4:3", "-s", "2.0", "-debug", "SILENT", "-o", "radargen-case-hawleyTx-zoomOut-newProj.png"};
...
//		
//		DateTime start = new DateTime(2024, 9, 14, 8, 30, 00,DateTimeZone.UTC);
//		DateTime end = new DateTime(2024, 9, 14, 10, 30, 00,DateTimeZone.UTC);
//		
...
//			
//			String[] args1 = {"-dt", dtArg, "-lat", "35.18", "-lon", "-97.44", "-a", "4:3", "-s", "2", "-debug", "VERBOSE", "-o", "radargen-sep14/" + oArg + ".png"};
//
//			RadarImageCli.main(args1);
//			
//			System.exit(0);
